...
class DrugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post drugs_url, params: { drug: { date_created: @drug.date_created, date_expire: @drug.date_expire, drug_name: @drug.drug_name, drug_price: @drug.drug_price } }
    end
  ...
  test "should update drug" do
    patch drug_url(@drug), params: { drug: { date_created: @drug.date_created, date_expire: @drug.date_expire, drug_name: @drug.drug_name, drug_price: @drug.drug_price } }
